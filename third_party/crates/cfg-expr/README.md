...
**A parser and evaluator for Rust `cfg()` expressions. Builtin targets as of [1.98.0] are supported.**
...
[![Rust Targets](https://img.shields.io/badge/Rust%20Targets-1.98.0-blue.svg)](https://doc.rust-lang.org/rustc/platform-support.html)
...
It contains a list of all builtin targets known to rustc as of [1.98.0] that can be used to determine if a particular cfg expression is satisfiable.
...
[1.98.0]: (https://doc.rust-lang.org/rustc/platform-support.html)
