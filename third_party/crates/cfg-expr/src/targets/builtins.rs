...
pub const ALL_BUILTINS: &[TargetInfo] = &[
    ...
    TargetInfo {
        triple: Triple::new_const("aarch64-oe-linux-gnu"),
        os: Some(Os::linux),
        abi: None,
        arch: Arch::aarch64,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("aarch64-unknown-linux-pauthtest"),
        os: Some(Os::linux),
        abi: Some(Abi::pauthtest),
        arch: Arch::aarch64,
        env: Some(Env::musl),
        vendor: Some(Vendor::unknown),
        families: Families::unix,
    ...
    TargetInfo {
        triple: Triple::new_const("aarch64-unknown-qnx"),
        os: Some(Os::qnx),
        abi: None,
        arch: Arch::aarch64,
        env: None,
    ...
    TargetInfo {
        triple: Triple::new_const("armv7-oe-linux-gnueabihf"),
        os: Some(Os::linux),
        abi: Some(Abi::eabihf),
        arch: Arch::arm,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("i686-oe-linux-gnu"),
        os: Some(Os::linux),
        abi: None,
        arch: Arch::x86,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("powerpc64-unknown-linux-gnuelfv2"),
        os: Some(Os::linux),
        abi: Some(Abi::elfv2),
        arch: Arch::powerpc64,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("riscv32imfc-unknown-none-elf"),
        os: None,
        abi: None,
        arch: Arch::riscv32,
        env: None,
    ...
    TargetInfo {
        triple: Triple::new_const("riscv64-oe-linux-gnu"),
        os: Some(Os::linux),
        abi: None,
        arch: Arch::riscv64,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("x86_64-oe-linux-gnu"),
        os: Some(Os::linux),
        abi: None,
        arch: Arch::x86_64,
        env: Some(Env::gnu),
    ...
    TargetInfo {
        triple: Triple::new_const("x86_64-pc-qnx"),
        os: Some(Os::qnx),
        abi: None,
        arch: Arch::x86_64,
        env: None,
...
impl super::Abi {
    ...
    pub const pauthtest: Abi = Abi::new_const("pauthtest");
...
impl super::Os {
    ...
    pub const qnx: Os = Os::new_const("qnx");
